                                ...
                                children: [
                                  ListTile(
                                    ...
                                    onTap: () async {
                                      ...
                                      if (result != null) {
                                        print(
                                            "Document choisi : ${result.files.single.path}");
                                      }
                                    },
                                  ),
                                  ListTile(
                                    ...
                                    onTap: () async {
                                      ...
                                      if (result != null) {
                                        print(
                                            "Image choisie : ${result.files.single.path}");
                                      }
                                    },
                                  ),
                                  ListTile(
                                    ...
                                    onTap: () async {
                                      ...
                                      if (result != null) {
                                        print(
                                            "Audio choisi : ${result.files.single.path}");
                                      }
                                    },
                                  ),
                                  ListTile(
                                    ...
                                    onTap: () async {
                                      ...
                                      if (result != null) {
                                        print(
                                            "Vidéo choisie : ${result.files.single.path}");
                                      }
                                    },
                                  ),
                                  ListTile(
                                    ...
                                    onTap: () async {
                                      ...
                                      if (result != null) {
                                        print(
                                            "Fichier choisi : ${result.files.single.path}");
                                      }
                                    },
                                  ),
                                ],
